...
1. Use `./devbox-master/os-bootstrap/os-boostrap.sh $ssh-key-name` script to update system packages, install open-vm-tools-desktop, install git and generate an ssh keypair.
